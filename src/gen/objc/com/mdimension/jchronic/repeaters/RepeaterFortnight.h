...
inline jint ComMdimensionJchronicRepeatersRepeaterFortnight_get_FORTNIGHT_SECONDS(void);
...
FOUNDATION_EXPORT ComMdimensionJchronicRepeatersRepeaterFortnight *new_ComMdimensionJchronicRepeatersRepeaterFortnight_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComMdimensionJchronicRepeatersRepeaterFortnight *create_ComMdimensionJchronicRepeatersRepeaterFortnight_init(void);
